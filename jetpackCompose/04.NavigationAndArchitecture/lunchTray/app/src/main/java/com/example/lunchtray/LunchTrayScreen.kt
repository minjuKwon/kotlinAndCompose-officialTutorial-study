...
enum class LunchTrayScreen(@StringRes val title: Int) {
    ...
    Main(title=R.string.choose_entree),
    Side(title=R.string.choose_side_dish),
    Snack(title=R.string.choose_accompaniment),
    Summary(title=R.string.order_checkout)
}
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route=LunchTrayScreen.Start.name){
                StartOrderScreen(
                    onStartOrderButtonClicked = { navController.navigate(LunchTrayScreen.Main.name) },
                    modifier= Modifier
                        .fillMaxSize()
            ...
            composable(route=LunchTrayScreen.Side.name){
                SideDishMenuScreen(
                    ...
                    onCancelButtonClicked = { cancelOrderAndNavigateToStart(viewModel, navController) },
                    onNextButtonClicked = { navController.navigate(LunchTrayScreen.Snack.name) },
            ...
            composable(route=LunchTrayScreen.Snack.name){
